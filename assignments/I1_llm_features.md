...
* *Statement on AI coding tools (0.5 page max):* Briefly describe whether and how you used AI coding tools and which ones. Briefly comment on how helpful you found them for this assignment and what obstacles you faced. We ask you not to use GenAI for creating this statement (e.g., a few honest bullet points with typos would be preferred over AI-generated slop).
